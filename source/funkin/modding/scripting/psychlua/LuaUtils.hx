...
class LuaUtils
{
	...
	public static function getTweenEaseByString(?ease:String = '') {
		switch(ease.toLowerCase().trim()) {
			...
			case 'outinback': return FlxEase.outInBack;
			...
			case 'outinbounce': return FlxEase.outInBounce;
			case 'circin': return FlxEase.circIn;
			case 'circinout': return FlxEase.circInOut;
			case 'circout': return FlxEase.circOut;
			case 'circoutin': return FlxEase.circOutIn;
			case 'outincirc': return FlxEase.outInCirc;
			case 'cubein': return FlxEase.cubeIn;
			case 'cubeinout': return FlxEase.cubeInOut;
			case 'cubeout': return FlxEase.cubeOut;
			case 'cubicoutin': return FlxEase.cubicOutIn;
			case 'outincubic': return FlxEase.outInCubic;
			...
			case 'outinelastic': return FlxEase.outInElastic;
			case 'expoin': return FlxEase.expoIn;
			case 'expoinout': return FlxEase.expoInOut;
			case 'expoout': return FlxEase.expoOut;
			case 'expooutin': return FlxEase.expoOutIn;
			case 'outinexpo': return FlxEase.outInExpo;
