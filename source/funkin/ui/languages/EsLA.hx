...
class EsLA 
{
    ...
    public static var translations:Map<String, String> = [
        ...
        "note_colors_legacy_subtitle" => "Con RGB apagado, los colores de notas usan offsets clásicos de Tono, Saturación y Brillo. Mismos sprites, vibra más retro.",
        "note_colors_legacy_preview_hint" => "CTRL cambia entre la vista normal y pixel. El carril seleccionado se actualiza en vivo abajo.",
        "note_colors_legacy_editor_hint" => "ARRIBA/ABAJO elige el carril. IZQUIERDA/DERECHA elige Tono, Saturación o Brillo. ENTER edita. RESET limpia el valor seleccionado, SHIFT + RESET limpia todo el carril.",
        ...
        "note_colors_legacy_footer" => "ENTER alterna el modo edición. CTRL cambia la vista pixel. ESC regresa.",
        ...
        "setting_flawless_rating" => "Usar rating Flawless",
        "description_flawless_rating" => "Si está marcado, el juego agrega el juicio Flawless!! por encima de Sick!. Desactívalo para usar Sick! como la calificación estándar más alta en la siguiente canción.",
