...
class EnUS 
{
    ...
    public static var translations:Map<String, String> = [
        ...
        "note_colors_legacy_title" => "Legacy Note Colors",
        "note_colors_legacy_subtitle" => "RGB is off, so note colors use classic Hue, Saturation and Brightness offsets. Same sprites, more old-school attitude.",
        "note_colors_legacy_preview_hint" => "CTRL toggles normal and pixel previews. The selected lane updates live below.",
        "note_colors_legacy_editor_hint" => "UP/DOWN picks the lane. LEFT/RIGHT picks Hue, Saturation or Brightness. ENTER edits. RESET clears the selected value, SHIFT + RESET clears the whole lane.",
        "note_colors_hue" => "Hue",
        "note_colors_saturation" => "Saturation",
        "note_colors_brightness" => "Brightness",
        "note_colors_legacy_mode_edit" => "Editing value",
        "note_colors_legacy_mode_select" => "Selecting lane / component",
        "note_colors_legacy_footer" => "ENTER toggles edit mode. CTRL changes pixel preview. ESC goes back.",
        "note_lane_0" => "Left",
        "note_lane_1" => "Down",
        "note_lane_2" => "Up",
        "note_lane_3" => "Right",
        ...
        "setting_note_rgb" => "Note RGB Shader",
        "description_note_rgb" => "If checked, notes use the RGB palette shader. Disable it to keep their original colors when possible.",
        ...
        "setting_flawless_rating" => "Use Flawless Rating",
        "description_flawless_rating" => "If checked, gameplay adds the Flawless!! judgement above Sick!. Disable it to use Sick! as the highest standard rating on the next song.",
