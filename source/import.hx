...
//import android.os.BatteryManager as AndroidBatteryManager; -- Disabled beacause extension-androidtools no have BatteryManager ...besides, it's not used anywhere 
#end
