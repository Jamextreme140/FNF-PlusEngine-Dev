...
class IdID 
{
    ...
    public static var translations:Map<String, String> = [
        ...
        "setting_visualizer_on_main_menu" => "Visualizer di Menu Utama",
        "description_visualizer_on_main_menu" => "Jika dicentang, visualisasi akan ditampilkan di menu utama. Aktifkan opsi ini jika Anda ingin menu utama terlihat keren.",
