...
class Build
{
	 ...
	 */
	public static final SKU:String = (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) ? JNI.createStaticField('android/os/Build', 'SKU',
		'Ljava/lang/String;')
		.get() : UNKNOWN;
	...
	{
		return JNI.createStaticMethod('android/os/Build', 'getSerial', '()Ljava/lang/String;')();
	}
}
...
class VERSION
{
	 ...
	 */
	public static final PREVIEW_SDK_INT:Int = JNI.createStaticField("android/os/Build$VERSION", 'PREVIEW_SDK_INT', 'I').get();
